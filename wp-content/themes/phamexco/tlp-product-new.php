                    ...
                    <div class="col-md-12 col-xs-12 title-sp">
                        <div class="breadcrumb_order">
                            <li class="breadcrumb_order1">
                                <a href="https://phamexco.vn/san-pham-noi-bat/">Sản Phẩm Nổi Bật</a>
                            </li>
                        </div>
                    </div>
                            ...
                            <div class="item col-xs-6 col-sm-4 col-md-4">
                                <div class="product-border">
                                    <?php if($product->get_sale_price()) : ?>
                                        <span>Gi?m: <?php echo number_format($product->get_regular_price() - $product->get_sale_price(), 0, ',', '.') . ' ?' ?></span>
                                    <?php endif ?>
                                    ...
                                    <?php else : ?>
                                        <p>
                                            <strong><?php echo number_format($product->get_regular_price(), 0, ',', '.') . '?' ?></strong>
                                        </p>
                                    <?php endif ?>
                                </div>
                            </div>
